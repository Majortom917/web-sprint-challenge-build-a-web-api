...
<!--  A: Node.js allows JavaScript to be run on the backend. Express is a framework for node that makes sending and receiving HTTP easier. -->
1. Understand and explain the use of Middleware.
 <!-- A:Middleware is a reusable function that parses and validates HTTP data before it reaches the router. it can choose to halt the progress of each request or send it forward -->
1. The basic principles of the REST architectural style.
 <!-- A: REST is a style where everything is a resource, everything is available via a unique URI, communication happens over a stateless protocol, and resource management happens via HTTP methods. -->
1. Understand and explain the use of Express Routers.
 <!-- A: Express routers allow a single source to handle multiple types of resources via unique URLS. -->
1. Describe tooling used to manually test the correctness of an API.
<!-- A: Postman and HTTPie are tools you can use to manually check APIs. -->
